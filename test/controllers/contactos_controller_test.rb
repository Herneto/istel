...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { assunto: @contacto.assunto, email: @contacto.email, mensagem: @contacto.mensagem, nome: @contacto.nome } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { assunto: @contacto.assunto, email: @contacto.email, mensagem: @contacto.mensagem, nome: @contacto.nome } }
