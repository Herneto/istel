...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { description: @curso.description, qt_estudantes: @curso.qt_estudantes, titulo: @curso.titulo } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { description: @curso.description, qt_estudantes: @curso.qt_estudantes, titulo: @curso.titulo } }
